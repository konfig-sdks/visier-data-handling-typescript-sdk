...
/**
 * This class provides a wrapper for network errors when making requests to Visier Data and Job Handling APIs
 */
export class VisierDataHandlingError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "VisierDataHandlingError";
